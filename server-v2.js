...
const mockData = {
  ...
  doctors: [
    { id: 1, name: 'Dr. Ahmed Hassan', specialization: 'Cardiology', phone: '+252-1-111111', email: 'ahmed@maareeye.com' },
    { id: 2, name: 'Dr. Fatima Mohamed', specialization: 'Pediatrics', phone: '+252-1-222222', email: 'fatima@maareeye.com' },
    { id: 3, name: 'Dr. Mohamed Ali', specialization: 'General Surgery', phone: '+252-1-333333', email: 'mohamed@maareeye.com' }
  ],
  patients: [
...
app.get('/api/health', (req, res) => {
  res.json({ status: 'OK', message: 'Maamule Hospital Management System System is running' });
});
...
app.listen(PORT, () => {
  console.log(`Maamule Hospital Management System System API running on port ${PORT}`);
